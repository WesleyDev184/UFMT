...
public:
  EmpregadoHorista(int horas, double taxa) : horasTrabalhadas(horas), taxaPorHora(taxa) {}
  ...
  void imprimirDetalhes() const override
  {
    cout << "Empregado Horista, Horas Trabalhadas: " << horasTrabalhadas << ", Taxa por Hora: " << taxaPorHora << endl;
  }
};
