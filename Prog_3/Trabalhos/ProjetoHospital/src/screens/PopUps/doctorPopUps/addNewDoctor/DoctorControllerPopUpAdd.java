package screens.PopUps.doctorPopUps.addNewDoctor;
...
public class DoctorControllerPopUpAdd implements Initializable {
  ...
  public void addNewDoctor() {
    try {
      ...
      Doctor doctor = new Doctor(0, name, date, newAddress, crm, selectedInsurance, Double.parseDouble(timeValue));
