...
{
       0,    39,    39,    47,    53,    57,    58,    59,    63,    67,
      74,    78,    85,    89,    96,   102,   105,   109,   112,   124,
     127,   130,   135,   138,   142,   146,   152,   155,   164
};
#endif
...
{
  "$end", "error", "$undefined", "VAR", "ID", "NUM", "LITERAL_STR", "INT",
  "FLOAT", "STR", "WRITE", "READ", "WRITELN", "'+'", "'-'", "'*'", "'/'",
  "'%'", "':'", "'='", "';'", "'{'", "'}'", "'('", "')'", "$accept",
  "programa", "declaracoes", "declaracao", "declaracao_inteiro",
...
static const yytype_int16 yytoknum[] =
{
     ...
     265,   266,   267,    43,    45,    42,    47,    37,    58,    61,
      59,   123,   125,    40,    41
};
# endif
...
{
       9,    10,    18,     8,     9,   -24,   -24,   -24,    12,   -24,
      27,   -24,   -24,    -1,    13,    11,    27,   -24,   -10,     4,
       6,    -4,   -24,   -24,    29,   -24,    30,   -24,    31,   -24,
     -24,   -24,    -4,    -9,     0,   -24,    16,    19,    20,   -11,
      -4,    -4,   -24,    -4,    -4,    -4,   -24,   -24,   -24,   -24,
       0,     0,   -24,   -24,   -24
};
...
{
       4,     0,     0,     0,     4,     5,     6,     7,     0,     1,
      16,     2,     3,     0,     0,     0,    16,    17,     0,     0,
       0,     0,    14,    15,     0,     9,     0,    11,     0,    13,
      27,    26,     0,     0,    19,    22,     0,     0,     0,     0,
       0,     0,    18,     0,     0,     0,     8,    10,    12,    28,
      20,    21,    23,    24,    25
};
...
{
      30,    31,    40,    41,    40,    41,    18,    19,    20,    24,
      25,    42,     1,    49,     8,    43,    44,    45,     9,    32,
      52,    53,    54,    26,    27,    28,    29,    50,    51,    10,
      13,    14,    21,    22,    36,    37,    46,    38,    12,    47,
      48,    23,     0,     0,     0,     0,    39
};

static const yytype_int8 yycheck[] =
{
       4,     5,    13,    14,    13,    14,     7,     8,     9,    19,
      20,    20,     3,    24,     4,    15,    16,    17,     0,    23,
      43,    44,    45,    19,    20,    19,    20,    40,    41,    21,
      18,     4,    19,    22,     5,     5,    20,     6,     4,    20,
      20,    16,    -1,    -1,    -1,    -1,    32
};
...
static const yytype_int8 yystos[] =
{
      ...
      21,    32,    27,    18,     4,    33,    34,    35,     7,     8,
       9,    19,    22,    33,    19,    20,    19,    20,    19,    20,
       4,     5,    23,    36,    37,    38,     5,     5,     6,    36,
      13,    14,    20,    15,    16,    17,    20,    20,    20,    24,
      37,    37,    38,    38,    38
};
...
#line 112 "sintatico.y"
                                                   {
		SymTableEntry* entry = findSymTable(&table, (yyvsp[-3].c).str);
		if (entry == NULL) {
...
#line 138 "sintatico.y"
		...
		makeCodeMul((yyval.c).str, (yyvsp[0].c).str);
	}
...
#line 155 "sintatico.y"
              {
		SymTableEntry* entry = findSymTable(&table, (yyvsp[0].c).str);
		if (entry == NULL) {
			yyerror("Variable not declared");
			YYABORT;
		}
